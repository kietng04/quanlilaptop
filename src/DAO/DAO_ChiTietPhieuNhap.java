...
public class DAO_ChiTietPhieuNhap implements DAOChiTietInterface<DTO_ChiTietPhieuNhap> {
    ...
    public int insert(ArrayList<DTO_ChiTietPhieuNhap> t) {
        ...
        for (int i = 0; i < t.size(); i++) {
            try {
                ...
                JDBCUtil.close(con);
                JOptionPane.showMessageDialog(null, "Them thanh cong chi tiet phieu nhap ne: " + result);
    ...
    public int delete(String t) {
        ...
        try {
            ...
            result = pst.executeUpdate();
            JDBCUtil.close(con);
            JOptionPane.showMessageDialog(null, "Xoa thanh cong chi tiet phieu nhap ne: " + result);
