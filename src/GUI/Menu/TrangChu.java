...
public class TrangChu extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Các đơn hàng gần đây");
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã đơn hàng", "Tên người đặt", "Số điện thoại", "Tổng đơn giá"
            }
        ) {
        ...
        if (table1.getColumnModel().getColumnCount() > 0) {
            ...
            table1.getColumnModel().getColumn(0).setHeaderValue("Tên");
            table1.getColumnModel().getColumn(1).setResizable(false);
            table1.getColumnModel().getColumn(1).setHeaderValue("Giới tính");
            table1.getColumnModel().getColumn(2).setResizable(false);
            table1.getColumnModel().getColumn(2).setHeaderValue("Số điện thoại");
            table1.getColumnModel().getColumn(3).setResizable(false);
            table1.getColumnModel().getColumn(3).setHeaderValue("Số hàng đã mua");
        }
