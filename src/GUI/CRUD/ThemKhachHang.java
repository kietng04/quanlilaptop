...
import GUI.Menu.KhachHang; // Add this import statement
...
form KhachHangDialog
    ...
    GUI.Menu.KhachHang khachHang;
    public ThemKhachHang(java.awt.Frame parent, boolean modal, GUI.Menu.KhachHang khachHang) {
        super(parent, modal);
        this.khachHang = khachHang;
        initComponents();
        // fill ma khach hang
        jTextField2.setText(khachHangBus.getMaxID() + 1 + "");
        
        jTextField7.setText(java.time.LocalDate.now().toString());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CÁI GÌ ĐÓ KHÁCH HÀNG");
        ...
        jToggleButton1.setText("Thêm khách hàng");
    ...
    private void jToggleButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jToggleButton1MousePressed
        // TODO add your handling code here: them khach hang
        String maKhachHang = jTextField2.getText();
        ...
        if (tenKh.length() > 50) {
            JOptionPane.showMessageDialog(null, "Tên khách hàng không được quá 50 kí tự");
            return;
        }
                if (diaChi.length() > 100) {
                    JOptionPane.showMessageDialog(null, "Địa chỉ không được quá 100 kí tự");
                    return;
                }
                DTO_KhachHang kh = new DTO_KhachHang(maKhachHang, tenKh, diaChi, sdt, ngayThem, gioiTinh);
                int result = khachHangBus.insert(kh);
                if (result > 0) {
                    JOptionPane.showMessageDialog(null, "Thêm khách hàng thành công");
                    khachHang.listKh = khachHangBus.getAllData(); 
                    khachHang.filltable(khachHang.listKh);
                    this.dispose();
                } else {
