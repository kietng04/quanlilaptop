...
public class ViewCauHinh extends javax.swing.JDialog {
    ...
    public void fillTablePhienBanSP() {       
            ...
            for (int i = 0; i < list.size(); i++) {
                row[0] = list.get(i).getRam() + " GB";
                row[1] = list.get(i).getRom() + " GB";
                row[2] = list.get(i).getGianhapVND();
                row[3] = list.get(i).getGiaxuatVND();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "RAM", "ROM", "Bộ xử lý", "Giá nhập", "Giá xuất", "Số lượng tồn"
            }
        ));
