...
public class DTO_PhieuNhap extends DTO_Phieu {
    ...
    public DTO_PhieuNhap( int maphieu, Timestamp thoigiantao, int manhacungcap ,int manguoitao, long tongTien, int trangthai) {
        super(maphieu, thoigiantao, manguoitao, tongTien, trangthai);
        this.manhacungcap = manhacungcap;
    }
